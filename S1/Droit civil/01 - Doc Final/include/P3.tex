...
\subsection{La preuve d'un fait juridique}

\subsubsection{Le fait juridique}

Le fait juridique est un événement dont les effets juridiques résultent de la Loi et non de la volonté de l'intéressé. La majorité légale est un événement dont les effets juridiques font que le mineur devenant majeur a pleine capacité juridique. Les effets liés à la majorité ne découlent pas de la volonté de l'intéressé: c'est un fait juridique. \\
Un accident de voiture est un fait juridique car l'accident (non voulu) aura pour conséquence la réparation et les dommages et intérêts que l'auteur devra payer (via son assurance). 


\subsubsection{La preuve d'un fait juridique}

En matière de fait juridique, la preuve peut être apporté par tous les moyens. Il n'y a pas de principes et d'exceptions. Le juge a entière souveraineté quant à l'appréciation de ces preuves. Il n'y a pas de hiérarchie quant aux preuves. 

\chapter{L'exercice des droits subjectifs}

\section{Transmission des droits subjectifs}

Nous allons ici parlé des droits subjectifs patrimoniaux, c'est à dire à des droits qui peuvent au final se convertir en argent, des droits qui ont donc une valeur. Le droit de propriété est par exemple un droit patrimonial: le droit de propriété d'un bien se vend. 


Il faut distinguer les ayant-causes à titre particulier et les ayant-causes à titre universel. \\
Un ayant-cause est celui à qui l'auteur transmet le droit. L'auteur transmet à l'ayant-cause son droit. \\
Dans le cadre d'un héritage, le parent décédé est l'auteur (c'est le défunt, ou De Cujus) et les héritiers sont les ayant-cause, ayant un nom spécifique: les héritiers. \\
L'on parle aussi dans certains cas des ayants-droit. 


Un ayant-cause à titre particulier est celui qui a reçu de son auteur un ou plusieurs biens déterminés. \\
Dans un héritage, si le défunt a déterminé par testament une liste de biens précis, chaque héritier sera considéré comme ayant-cause à titre particulier. \\
En revanche, lorsqu'on parle d'un ayant-cause à titre universel quand l'ayant-cause va acquérir de l'auteur soit l'intégralité des biens du défunt soit une partie de l'intégralité des biens. 


Deux maximes relatives à la transmission des droits subjectifs: \\


"Nul ne peut transmettre à autrui plus de droit qu'il n'en a lui même" L'auteur ne peut transmettre que jusqu'à hauteur maximal des droits patrimoniaux qu'il possède lui même. \\
"Nul ne peut transmettre à autrui ce qu'il n'a pas" Pour transmettre, il faut s'assurer que le droit subjectif patrimonial est en notre possession. 

\section{Limitation à l'exercice des droits subjectifs}

La question qui se pose est lorsque quelqu'un est titulaire d'un droit subjectif, est-ce que les prérogatives attachées à ce droit sont absolus, discrétionnaire, sans limites ? \\
Un exemple célèbre en jurisprudence concerne le droit des biens et de propriété: affaire qui se situe fin du XIXe siècle et début du XXe siècle avec la propagation des montgolfières. Clement-Bayard fabrique montgolfière et dirigeable et son voisin ne supporte pas de les voir passer sur son terrain. La C.Cas va avoir deux théories qui vont entrer en conflit: la théorie absolutiste, au nom duquel le propriétaire de son terrain fait ce qu'il veut sur son terrain  (article 544 du Code Civil), il se fonde donc sur la lettre du Code Civil ; la deuxième théorie considère que le droit de propriété, l'exercice de celui-ci, peut dégénérer en abus. Cette deuxième théorie est la théorie de l'abus du droit de propriété. Pour les tenants de cette théorie, le droit de propriété connaît des limites au nom de finalités sociales d'ordre collectif. \\
La C.Cas va penché pour l'abus de droit possible dans une décision rendu par la chambre des requêtes le 3 août 1915 et à considéré que l'on pouvait parler d'abus de propriété. Il y a abus lorsqu'un propriétaire utilise sa propriété dans le seul but d'être malveillant. Si il y a abus de droit, le titulaire de celui-ci est privé de l'exercice de ce droit mais il peut éventuellement être aussi condamné à payer des dommages et intérêts si l'abus a eu pour conséquence de porter préjudice à autrui. 

\part{Théorie générale des droits subjectifs}

\chapter{Les différents droits subjectifs}

Au titre des différents droits subjectifs, on trouve trois catégories, dans lesquelles il y a des droits qui peuvent relever de deux des trois catégories.

\section{Les actes et faits juridiques}



\section{Les droits patrimoniaux}

Deux grandes familles: les droits réels et les droits personnels. 


Parler de droit réel renvoie au terme "res" qui signifie "la chose", donc parler de droit réel renvoie au droit portant sur les choses. Ces choses sont en droit français de deux ordres: choses mobilière, chose immobilière. En droit des choses, un meuble peut bouger. Un immeuble est quelque chose qui ne peuvent pas bouger, ou, du moins, qui n'a pas à bouger. \\
Un bien est une chose et son droit appliqué dessus. \\
Le droit réel est un droit direct sur la chose, ce qui signifie que puisqu'il y a un droit direct sur la chose, il n'y a pas d'intermédiaire entre le droit et la chose. Ce droit est d'opposabilité absolue.

\subsection{Les principaux droits réels}

\subsubsection{Le droit de propriété dans sa globalité}

Lorsque l'on est propriétaire d'une chose, d'un bien donc, c'est que l'on possède trois prérogatives qui vont constitué le droit de propriété dans sa globalité: ils découlent de l'article 544 du Code Civil: l'abusus, le fructus, et l'usus. L'abusus est de disposer (droit de vendre, d'utiliser, de détruire) de la chose. Le fructus est le droit de recueillir le fruit de cette chose (fruit civil comme un loyer par exemple). L'usus est tout simplement le droit d'user de la chose (il y a usus si après utilisation, la chose existera encore). \\
Je suis propriétaire d'un bien lorsque je possède ces trois caractéristiques. 

\subsubsection{Le droit de propriété dans ses éléments: le droit de propriété démembré}

Le droit de propriété est un droit réel dans sa globalité, mais chacun des éléments qui le composent peuvent être séparés et sont tous chacun des droits réels principaux. \\
Parfois, l'on a deux prérogatives qui appartiennent à quelqu'un, et la troisième à quelqu'un d'autre comme dans une location où le locataire à le droit d'user le bien (usus), mais c'est le propriétaire qui en dispose et qui en récolte les fruits. \\
Si deux personnes mariés prennent les dispositions testamentaires adéquates, l'héritage peut se faire en usufruit: le conjoint survivant peut user de son héritage (habiter dans une maison hérité par exemple), mais aussi d'en récolter les fruits. Quand le droit de disposer est mis à l'écart, on parle de nu propriété. L'abusus est tenu conjointement par la personne qui possède l'usufruit avec l'héritier légitime: l'abusus est séparé en deux. 

\subsection{Les droits réels accessoires}

Dans certaines situations, il y a une certaine nécessité notamment en matière d'immeuble de protéger celui qui va prêter de l'argent pour l'acquisition d'une maison. \\
L'acheteur demande à un banquier de lui faire un prêt. Ce banquier veut être sûr qu'il sera payé, remboursé de la somme qu'il a prêté avec les intérêts. Ce banquier peut se trouver dans une situation dans laquelle il souhaite une garantie: ce que l'on appelle une sûreté réelle immobilière. Cette sûreté réelle immobilière est ce que l'on appelle une hypothèque. C'est un droit réel accessoire. \\
À côté du droit réel principal de l'acheteur, il y a donc le droit réel accessoire du banquier sur la maison. 


Le droit personnel est un droit indirect à la chose par l'intermédiaire d'une personne. En matière de droit personnel, on parlera de droit "médiat" à la chose, par la "médiation" de quelqu'un. \\
Lorsque l'on achète un bien, on a pas de droit direct sur celui-ci. C'est par le médiat du propriétaire que l'acheteur va acquérir son bien. L'acheteur (créancier) a donc une relation de droit personnel avec le vendeur (débiteur). \\
Le droit personnel, c'est le droit qu'a un créancier à l'égard d'un débiteur d'obtenir une chose. 


Si le droit réel est un droit d'opposabilité absolue, le droit personnel est d'une opposabilité relative: ne concerne que les parties à l'opération (le créancier et le débiteur).

\subsection{Les droits intellectuels}

Un droit subjectif est dit intellectuel lorsqu'il confère à son titulaire un monopole d'exploitation notamment sur des oeuvres de l'esprit. Ainsi, lorsque je parle d'un écrivain qui va faire publier son livre chez un éditeur, il est titulaire d'une propriété intellectuelle. Ce monopole d'exploitation est d'opposabilité absolu.

\section{Les droits extra-patrimoniaux}

On parle de droits extra-patrimoniaux dès l'instant où ce sont des droits non évaluable en argent ; on ne peut pas, en principe, monnayer ces droits: on ne peut pas non plus les transmettre. \\
Il y a d'abord la catégorie des droits familiaux: droit à la fidélité, droit à l'autorité parentale. \\
Les droits à la personnalité sont des droits inhérents à la personne humaine: ils concernent le corps humain, le respect de la vie privé, la dignité humaine etc. \\
Même si en principe, une approche pécuniaire n'est pas possible sur ces droits ci, il arrive que moyennant argent, dans le domaine des célébrités par exemple, ils acceptent de prendre des photos de leurs vies privés.

\chapter{Le patrimoine}

\section{Définition du patrimoine}

Le patrimoine d'une personne est l'universalité comprenant l'ensemble de ses biens et obligations présents et à venir (ainsi que de ses droits subjectifs patrimoniaux). \\
Toute personne physique ou morale a un patrimoine (et un seul). Ce patrimoine est une prérogative liée aux personnes. Le patrimoine doit se voir comme un contenant que tout le monde possède mais que tout le monde remplit différemment. 

\section{Fonction du patrimoine}

L'actif du patrimoine répond du passif. \\
C'est à dire que l'actif du patrimoine, composé de biens, ayant une valeur, répond du passif qui sont des dettes. 
